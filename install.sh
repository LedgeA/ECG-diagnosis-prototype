...
#
# You do NOT need to activate anything afterwards. pipeline/run_all.sh calls
# this interpreter by absolute path; if you installed elsewhere, point it there
# with ECGKIT_PY=/some/path/bin/python.
set -euo pipefail
